...
const cardsMarkup = createCardsMarkup((0, _appDefault.default));
...
function createCardsMarkup(dataGallery) {
    return dataGallery.map(({ preview , original  })=>{
        return `
...
function onBackdropClick(event) {
    ...
    if (event.currentTarget === event.target) console.log("click v bacdrop");
    closeModal();
}
...
function onLeftRight(event) {
    if (event.code === "ArrowLeft") ref.modalImg = ref.modalImg.src;
    else if (event.code === "ArrowRight") ref.modalImg = ref.modalImg.src + 1;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./app":"bNKaB"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire5306")
